...
Gentle reader, this library doth furnish thy Python terminal tools with reports most manifold: to the machine in ordered son of Jay, to the pipe in honest TSV, and to thine own eye in fair display — every format, verily, **as thou likest it**.
